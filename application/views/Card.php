...
<html>
  ...
  <div class="card-deck">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a class="card-title" href="http://localhost/CI_Tekweb_kel2/Teknologiweb-DSE-B-Kelompok2/index.php/Home/CV2">Alfin Gerliandeva</a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a class="card-title" href="http://localhost/CI_Tekweb_kel2/Teknologiweb-DSE-B-Kelompok2/index.php/Home/CV3">Adhani Mulianti</a>
      </div>
    </div>
  </div>
</body>
